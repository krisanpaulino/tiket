                        ...
                        <div class="dropdown topbar-head-dropdown ms-1 header-item" id="notificationDropdown">
                            ...
                            <div class="dropdown ms-sm-3 header-item topbar-user">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a class="dropdown-item" href="{{ route('profile.admin') }}"><i
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="\admin" aria-expanded="false">
                                <i class="ri-dashboard-2-line"></i> <span data-key="t-widgets">Dashboard</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('rute.index') }}" aria-expanded="false">
                                <i class="ri-route-line"></i> <span data-key="t-widgets">Rute</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('bus.index') }}" aria-expanded="false">
                                <i class="ri-bus-2-line"></i> <span data-key="t-widgets">Bus & Jadwal</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('admin.transaksi') }}"
                                aria-expanded="false">
                                <i class="ri-coupon-line"></i> <span data-key="t-widgets">Transaksi</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('checkin') }}" aria-expanded="false">
                                <i class="ri-checkbox-multiple-line"></i> <span data-key="t-widgets">Check In</span>
                            </a>
                        </li>
                        <li class="menu-title"><span data-key="t-menu">Laporan</span></li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('admin.laporan') }}" aria-expanded="false">
